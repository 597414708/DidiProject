//
//  ChangePasViewController.m
//  iOSDiDidadaProjiect
//
//  Created by 程磊 on 2017/12/21.
//  Copyright © 2017年 程磊. All rights reserved.
//

#import "ChangePasViewController.h"

@interface ChangePasViewController ()<UITextFieldDelegate>
{
    NSInteger _index;
    BOOL isBool;
}
...
@implementation ChangePasViewController
...
- (IBAction)quedingAction:(UIButton *)sender {
    ...
    [APIManager UserRestPwdWithParameters:pram success:^(id data) {
...
- (void)dealloc
{
    MyLog(@"-ChangePasViewController-释放");
